...
foreach ($awo_goods as $key => $goods)
{
	...
	$html_catalog_goods_1 .= '<td style="padding:5px; width: 153px;">';
	...
	$html_catalog_goods_2 .= '<td style="padding:5px; width: 153px;">';
	if(trim($url_page) != '')
	{
	...
	$html_catalog_goods_3 .= '<td style="padding:5px; width: 153px;">';
